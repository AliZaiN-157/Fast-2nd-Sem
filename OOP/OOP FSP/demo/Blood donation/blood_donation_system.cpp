...
class Admin
{
	...
	public:	
		...
		{
			int choice;
			cout<<"\t\t\t\tFast Blood Bank"<<endl<<endl;
...
void mainscreen(){
	...
	char head2[40]= "T O ";
	char head3[60]= "F A S T  B L O O D  B A N K";
...
int main()
{
	SetConsoleTitle("Blood Donation System | Fast Blood Bank");
	system("COLOR 70");
...
//		cout<<"\t\t\t\tBLOOD DONATION SYSTEM\n";
		...
		if(choice==1)
		{
			...
			int count,count1;
				...
				cout<<"\t\t\t\tFast Blood Bank"<<endl<<endl<<endl<<"\t\t\t\t\tAdmin";
